...
CREATE POLICY "All Operations for authenticated users" ON "public"."orders" TO "authenticated" USING (true);

CREATE POLICY "App Operations for authenticated users" ON "public"."order_items" TO "authenticated" USING (true);

CREATE POLICY "Enable access for authenticated users only" ON "public"."products" TO "authenticated" USING (true);
